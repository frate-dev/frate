...
namespace Test::Generators {
  ...
  namespace CMakeLists {
    ...
    bool testCmakeVersion() {
      std::vector<std::string> failing_versions{
          "5.69", "5.42", "6.69", "7.77", "9.69"};
    ...
    bool testProjectVersion() {
      std::vector<std::string> passing_project_versions = {"5.4.5",
                                                           "0.0.1",
                                                           "6.42.0",
                                                           "1.0.2",
                                                           "1.1.1",
                                                           ...
                                                           "0.0.0",
                                                           "1.0.0"};
      std::vector<std::string> failing_project_versions = {
          "q4.26.*", "123902", "5.xx42069", "420x69", "42x69x420"};
    ...
    bool testCLanguageVersion() {
      ...
      std::vector<std::string> failing_c_language_versions = {
          "3", "69", "420", "69.420", "69.420.69", "69.420.69.420"};
    ...
    bool testCppLanguageVersion() {
      std::vector<std::string> failing_cpp_language_versions = {
          "3", "69", "420", "69.420", "69.420.69", "69.420.69.420"};
    ...
    bool testCCompiler() {
      std::vector<std::string> failing_c_compilers = {"fuckcusecpp",
                                                      "clangdeeznuts"};
    ...
    bool testCppCompiler() {
      ...
      std::vector<std::string> failing_cpp_compilers = {
          "fuckitidontknow", "iforgot", "icc", "tcc", "emcc", "clang"};
    ...
    bool testSourceDir() {
      std::vector<std::string> passing_source_dirs = {"src",
                                                      "source",
                                                      "sources",
                                                      "srcs",
                                                      "src_dir",
                                                      ...
                                                      "sources_dir",
                                                      "srcs_dir"};
      std::vector<std::string> failing_source_dirs = {"S*($#*(@",
                                                      "*(\&\$\^",
                                                      "srcs_dir//*$",
                                                      long_string,
                                                      "src_dir//348934",
    ...
    bool testBuildDir() {
      std::vector<std::string> passing_build_dirs = {
          "build", "build_dir", "builds", "builds_dir"};
      std::vector<std::string> failing_build_dirs = {"B*($#*(@",
                                                     "*(\&\$\^",
                                                     "builds_dir//*$",
                                                     "build_dir//348934",
                                                     long_string,
    ...
    bool testIncludeDir() {
      std::vector<std::string> passing_include_dirs = {
          "include", "include_dir", "includes", "includes_dir"};
      std::vector<std::string> failing_include_dirs = {"I*($#*(@",
                                                       "*(\&\$\^",
                                                       "includes_dir//*$",
                                                       long_string,
                                                       "include_dir//348934",
