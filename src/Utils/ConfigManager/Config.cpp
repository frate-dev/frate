...
namespace Frate::Config {
  ...
  bool ConfigManager::createNew() {
    ...
    try {
      ...
      Utils::error << "Failed to create new config directory: " << e.what()
                   << std::endl;
      return false;
    }
    ...
    try {
      ...
      Utils::error << "Failed to create new config file: " << e.what()
                   << std::endl;
      return false;
    }
    try {
      ...
      Utils::error << "Failed to write to new config file: " << e.what()
                   << std::endl;
      return false;
    }
