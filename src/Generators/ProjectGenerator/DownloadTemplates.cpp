...
namespace Frate::Generators::Project {
  ...
  bool downloadTemplate(std::string git_url, path project_path) {
    ...
    //       Utils::error << "Clone status code: " << template_clone_status <<
    //       std::endl; if(template_clone_err){
    //         Utils::error << "Error while cloning repository error code: " <<
    //         template_clone_err->klass << std::endl;
    //       }else{
    ...
    //       << (project_path / "template/frate-callbacks").c_str() <<
    //       std::endl;
    //
    ...
    //       Utils::error << "Clone status code: " << callbacks_clone_status <<
    //       std::endl; if(callbacks_clone_err){
    //         Utils::error << "Error while cloning repository error code: " <<
    //         callbacks_clone_err->klass << std::endl;
    //       }else{
    //         Utils::error << "Error while cloning repository" << std::endl;
    //       }
    //       return false;
    ...
    int status =
        Utils::hSystem("git clone -b " + Constants::TEMPLATE_BRANCH + " " +
